...
m = 32; % Number of Antennas in One Antenna group
kr = 128; % Number of users in the sub circle
N = 2048; % Subcarriers
ka = 32; % Sparsity level and Number of active users in the sub circle
S = 32; % Sparsity level and Number of active users in the sub circle
snr = 30; % SNR value
...
title(lgd, 'CS Algorithms');
xlabel('Transaction Number (for 16 Groups of 128 Antennas)& SNR=22dB');
